...
class TestUtil(unittest.TestCase):
    ...
    def test_merge_args_kwargs(self):
        """Test merge_args_kwargs."""

        def f1(a, b, c, d=1, *, e=2, f=3, **kwargs):
            pass

        args, kwargs = objax.util.merge_args_kwargs([1], {'d': 3, 'x': 10}, f1)
        self.assertEqual(args, [1])
        self.assertEqual(kwargs, {'d': 3, 'x': 10})

        args, kwargs = objax.util.merge_args_kwargs([1, 2], {'d': 3, 'a': 10}, f1)
        ...
        args, kwargs = objax.util.merge_args_kwargs([1, 2], {'d': 3, 'x': 10}, f2)
        self.assertEqual(args, [1, 2])
        self.assertEqual(kwargs, {'d': 3})

        args, kwargs = objax.util.merge_args_kwargs([1, 2], {'d': 3, 'b': 10, 'x': 20}, f2)
        ...
        args, kwargs = objax.util.merge_args_kwargs([1, 2, 3, 4, 5, 6], {'d': 3, 'x': 10}, f3)
        self.assertEqual(args, [1, 2, 3, 4, 5, 6])
        self.assertEqual(kwargs, {'d': 3, 'x': 10})

        args, kwargs = objax.util.merge_args_kwargs([1, 2, 3, 4, 5, 6], {'d': 3, 'b': 10}, f3)
        ...
        args, kwargs = objax.util.merge_args_kwargs([1, 2, 3], {'d': 3, 'a': 10}, f4)
